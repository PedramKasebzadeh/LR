...
Also using QR decomposition, the estimates of beta and var(beta) were computed.
...
linreg <- setRefClass(Class = "linreg",
                      ...
                      methods = list(
                        ...
                        a<-paste("Residual standard error",sqrt(Sigma_square),"on",
                                   dfreedom, "degrees of freedom")
